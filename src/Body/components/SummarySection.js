    ...
    <StyledSummarySection>
      ...
      <p>
        <p>I'm a computer science student at Boston College. I love things with elegant
          ...
          that combine the two that makes our every day lives easier.<br/></p>
        <p>
          ...
          - creating app designs and visualizing the animations in my mind.<br/>
        </p>
        <p>
          ...
          data-personalized life in the future.<br/>
        </p>
      </p>
    </StyledSummarySection>
  );
